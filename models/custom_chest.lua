...
local basename = "custom_chest"
local description = S("Custom Chest")
local tt_help = S("Custom Chest are containers which provide 27 inventory slots.")
...
local small_textures = {"mcl_custom_chest.png"}
--[[
